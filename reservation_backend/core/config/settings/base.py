"""
Base Django settings for reservation backend.
"""
import os
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_DATETIME_FORMAT': 'iso-8601',
    'DEFAULT_RENDERER_CLASSES': [
        'rest_framework.renderers.JSONRenderer',
    ],
}
...
# Django Spectacular (OpenAPI) configuration
SPECTACULAR_SETTINGS = {
    'TITLE': 'Reservation API',
    'DESCRIPTION': 'A professional reservation system API',
    'VERSION': '1.0.0',
...
UPLOAD_FILE_MAX_SIZE = 5 * 1024 * 1024  # 5MB
...
if DEBUG:
    ...
    # Auto-detect allowed hosts for development
    try:
        hostname = socket.gethostname()
        local_ip = socket.gethostbyname(hostname)
        ALLOWED_HOSTS.extend([local_ip, hostname])
    except:
        pass
